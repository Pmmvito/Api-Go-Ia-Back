    ...
    "paths": {
        ...
        "/auth/change-password": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Dados inválidos: senha atual e nova senha (mínimo 6 caracteres) são obrigatórios | Nova senha deve ser diferente da senha atual",
                        "schema": {
                            "$ref": "#/definitions/handler.ErrorResponse"
                        }
                    },
                    "401": {
                        "description": "Senha atual incorreta. Verifique e tente novamente | Unauthorized",
                        "schema": {
                            "$ref": "#/definitions/handler.ErrorResponse"
                        }
                    },
                    "500": {
                        "description": "Erro ao processar nova senha | Erro ao atualizar senha",
                        "schema": {
                            "$ref": "#/definitions/handler.ErrorResponse"
                        }
                    }
        ...
        "/auth/forgot-password": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Dados inválidos: email é obrigatório e deve ser válido",
                        "schema": {
                            "$ref": "#/definitions/handler.ErrorResponse"
                        }
                    },
                    ...
                    "500": {
                        "description": "Erro ao gerar código de recuperação | Erro ao enviar email",
                        "schema": {
                            "$ref": "#/definitions/handler.ErrorResponse"
                        }
                    }
        ...
        "/auth/reset-password": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Email, token and new password",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Dados inválidos | Código deve ter 6 dígitos | Senha deve ter no mínimo 6 caracteres",
                        "schema": {
                            "$ref": "#/definitions/handler.ErrorResponse"
                        }
                    },
                    ...
                    "500": {
                        "description": "Erro ao atualizar senha | Erro ao enviar email de confirmação",
                        "schema": {
                            "$ref": "#/definitions/handler.ErrorResponse"
                        }
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.ConfirmEmailRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "401": {
                        "description": "Código inválido ou expirado | Unauthorized",
                        "schema": {
                            "$ref": "#/definitions/handler.ErrorResponse"
                        }
                    },
        ...
        "/user/profile": {
            "patch": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Dados inválidos | Nenhum campo para atualizar",
                        "schema": {
                            "$ref": "#/definitions/handler.ErrorResponse"
                        }
                    },
        ...
        "/user/request-email-change": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Dados inválidos | Email já em uso",
                        "schema": {
                            "$ref": "#/definitions/handler.ErrorResponse"
                        }
                    },
