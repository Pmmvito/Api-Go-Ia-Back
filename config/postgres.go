...
func InitializePostgreSQL() (*gorm.DB, error) {
	...
	err = db.AutoMigrate(
		...
		&schemas.PasswordReset{},  // 4. Tokens de recuperação de senha (depende de User)
		&schemas.Category{},       // 5. Categorias (independente)
		&schemas.Product{},        // 6. Produtos (depende de Category)
		&schemas.Receipt{},        // 7. Notas fiscais (depende de User)
		&schemas.ReceiptItem{},    // 8. Itens de nota (depende de Receipt e Product)
		&schemas.ShoppingList{},   // 9. Listas de compras (depende de User)
		&schemas.ListItem{},       // 10. Itens de lista (depende de ShoppingList e Product)
	)
	if err != nil {
