...
// ShoppingList representa uma lista de compras de um usuário.
type ShoppingList struct {
	...
	Name   string     `json:"name" gorm:"not null"`                                               // Nome da lista de compras
	Items  []ListItem `json:"items" gorm:"foreignKey:ShoppingListID;constraint:OnDelete:CASCADE"` // Relacionamento HasMany com ListItem
}

// ListItem representa um item dentro de uma lista de compras.
type ListItem struct {
	gorm.Model
	ShoppingListID uint      `json:"shoppingListId" gorm:"not null;index"`            // Chave estrangeira para ShoppingList
	...
	Quantity       float64   `json:"quantity" gorm:"type:decimal(10,3);not null"`     // Quantidade desejada do item
...
// ShoppingListResponse define a estrutura dos dados da lista de compras para respostas da API.
...
// ListItemResponse define a estrutura de um item da lista de compras para respostas da API.
...
// ToResponse converte uma ShoppingList para o formato ShoppingListResponse.
